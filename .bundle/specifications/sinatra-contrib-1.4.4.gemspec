# -*- encoding: utf-8 -*-
# stub: sinatra-contrib 1.4.4 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.require_paths = ["lib"]
  s.authors = ["Konstantin Haase", "Gabriel Andretta", "Zachary Scott", "Trevor Bramble", "Katrina Owen", "Nicolas Sanguinetti", "Ashley Williams", "Hrvoje \u{160}imi\u{107}", "Masahiro Fujiwara", "Rafael Magana", "Vipul A M", "Jack Chu", "Ilya Shindyapin", "Jake Worth", "Kashyap", "Sumeet Singh", "lest", "Adrian Paca\u{142}a", "Aish", "Alexey Chernenkov", "Andrew Crump", "Bo Jeanes", "David Asabina", "Eliot Shepard", "Eric Marden", "Gray Manley", "Guillaume Bouteille", "Jamie Hodge", "Koichi Sasada", "Kyle Lacy", "Lars Vonk", "Martin Frost", "Mathieu Allaire", "Matt Lyon", "Matthew Conway", "Meck", "Michi Huber", "Nic Benders", "Patricio Mac Adden", "Reed Lipman", "Samy Dindane", "Sergey Nartimov", "Thibaut Sacreste", "Uchio KONDO", "Will Bailey", "ashley williams", "undr"]
  s.date = "2015-06-06"
  s.description = "Collection of useful Sinatra extensions"
  s.email = ["konstantin.mailinglists@googlemail.com", "ohhgabriel@gmail.com", "inbox@trevorbramble.com", "e@zzak.io", "zachary@zacharyscott.net", "katrina.owen@gmail.com", "contacto@nicolassanguinetti.info", "ashley@bocoup.com", "shime.ferovac@gmail.com", "m-fujiwara@axsh.net", "raf.magana@gmail.com", "vipulnsward@gmail.com", "jack@jackchu.com", "konstantin.haase@gmail.com", "ilya@shindyapin.com", "jworth@prevailhs.com", "kashyap.kmbc@gmail.com", "ortuna@gmail.com", "tbramble@chef.io", "just.lest@gmail.com", "altpacala@gmail.com", "aisha.fenton@visfleet.com", "laise@pisem.net", "andrew.crump@ieee.org", "me@bjeanes.com", "david@supr.nu", "eshepard@slower.net", "eric.marden@gmail.com", "g.manley@tukaiz.com", "duffman@via.ecp.fr", "jamiehodge@me.com", "ko1@atdot.net", "kylewlacy@me.com", "lars.vonk@gmail.com", "blame@kth.se", "mathieuallaire@gmail.com", "matt@flowerpowered.com", "himself@mattonrails.com", "yesmeck@gmail.com", "michi.huber@gmail.com", "nic@newrelic.com", "patriciomacadden@gmail.com", "rmlipman@gmail.com", "samy@dindane.com", "just.lest@gmail.com", "thibaut.sacreste@gmail.com", "udzura@udzura.jp", "will.bailey@gmail.com", "ashley666ashley@gmail.com", "undr@yandex.ru"]
